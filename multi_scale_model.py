...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=6):
        ...
        self.conv1 = nn.Conv1d(2, 64, kernel_size=32, stride=1, padding=16, bias=False)
        ...
        self.layer5 = self._make_layer(block, 1024, layers[4], stride=1)
        self.avgpool = nn.AvgPool1d(6, stride=1)
...
def multi_scale(**kwargs):
    model = ResNet(BasicBlock, [2, 3, 4, 4, 3], **kwargs)
    return model
