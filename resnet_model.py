...
class C1DPadSame(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, groups=1):
        super(C1DPadSame, self).__init__()
...
class ResNet1D(nn.Module):
    def __init__(self, in_channels, base_filters, kernel_size, stride, groups, n_block, n_classes, downsample_gap=2,
                 increase_filter_gap=6, use_bn=True, use_do=False, verbose=False):
        ...
        self.increase_filter_gap = increase_filter_gap  # 4 for base model

        # first block
        self.first_block_conv = C1DPadSame(in_channels=in_channels, out_channels=base_filters,
        ...
        for i_block in range(self.n_block):
            ...
            if is_first_block:
                ...
                if (i_block % self.increase_filter_gap == 0) and (i_block != 0):
